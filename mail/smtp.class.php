...
* @example
* $mail = new SMTP();
* $mail->setServer("smtp@126.com", "XXXXX@126.com", "XXXXX"); 
* $mail->setServer("smtp.gmail.com", "XXXXX@gmail.com", "XXXXX", 465, true); 
* $mail->setFrom("XXXXX","XXXX"); 
* $mail->setReceiver("XXXXX","XXXX"); 
* $mail->setCc("XXXX"); 
* $mail->setBcc("XXXXX"); 
...
class SMTP {
	...
	* @return boolean
	*/
	public function setReceiver($to, $toName="") {
		$this->_to[] = $to;
		$this->_toName[]=$toName;
		return true;
	}
	...
	protected function getCommand() {
		...
		if(!empty($this->_to)) {
			...
			if($count == 1){
				...
				$header .= "TO: " . $this->_toName[0] . "<" . $this->_to[0] .">\r\n";
			}
			else{
				for($i=0; $i<$count; $i++){
